...
if __name__ == '__main__':
    ...
    #print('주소록 프로그램!')
    # 3. 클래스 실행 - 객체를 생성
    # first = contact.Contact('환호', '010-1234-5678', 'hhp2030@naver.com', '부산')
    # print(first)
    run() # 제일 처음 실행되는 함수
